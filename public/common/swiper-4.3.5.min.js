...
!(function(e, t) {
  ...
  var e,
    ...
    X = {
      ...
      getTranslate: function(e, t) {
        let a, i, s;
        void 0 === t && (t = "x");
        const r = B.getComputedStyle(e, null);
        return (
          B.WebKitCSSMatrix
  ...
  (s.prototype.on = function(e, t, a) {
    ...
    (s.installModule = function(t) {
      ...
      const s =
        t.name || Object.keys(i.prototype.modules).length + "_" + X.now();
      return (
        ...
        for (
          ...
          if ("none" !== k.css("display")) {
            if ("auto" === t.slidesPerView) {
              const I = B.getComputedStyle(k[0], null),
  ...
  const b = {
    attachEvents: function() {
      ...
      const r = "container" === t.touchEventsTarget ? i : s,
        n = !!t.nested;
